...
\begin{myproof}
  Let us prove the third item. Let $y \in GL (A)$. If $\|x - y\| \leq \frac{1}{\|y^{-1}\|}$, 
  then $$\| 1 - xy^{-1}\| = \| (y - x) y^{-1}\| \leq \| y - x\| \|y^{-1}\| \leq 1,$$
  which implies that $xy^{-1} \in GL (A)$ and so $x = xy^{-1} \cdot y \in GL (A)$. We have proved that $GL(A)$ is open.
  Using the same notation and $(xy^{-1})^{-1} = (1-(1 - xy^{-1}))^{-1}$, we get 
...
\begin{myproof}
  ...
  So $x - \lambda = 0$ and $x = \lambda \in \C$.
\end{myproof}
...
\begin{myproof}
  ...
  Now for the other inclusion $(\supseteq)$:
...
\begin{theorem}
  ...
  \begin{enumerate}
    ...
    large enough $n$, we have $\sigma(x_n) \subseteq \Omega$ and $\|f(x_n) - f(x)\| \to 0$.
  \end{enumerate}
\end{theorem}
